...
CREATE TABLE IF NOT EXISTS lesson (
    ...
    INDEX idx_series_date (series_id, lesson_date),
    INDEX idx_student_date (student_id, lesson_date),
    INDEX idx_course_date (course_id, lesson_date),
...
-- INSERT INTO lessons (teacher_id, student_id, course_id, lesson_date, lesson_time, duration, frequency, notes, payment_amount, payment_method)
-- VALUES 
