                    ...
                    <div class="user-profile d-flex no-block dropdown m-t-20">
                        ...
                        <div class="user-content hide-menu m-l-10">
                            <a href="#" class="" id="Userdd" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <h5 class="m-b-0 user-name font-medium"><? //$userName ?> Add Username <i class="fa fa-angle-down"></i></h5>
                            </a>
...
<!--                </li>-->
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="student.php" aria-expanded="false">
                        <i class="mdi mdi-account-network"></i><span class="hide-menu">Students</span>
                    </a>
                </li>
                <li class="sidebar-item">
